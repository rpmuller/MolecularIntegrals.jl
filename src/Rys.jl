...
function Recur(G,t,i,j,k,l,xi,xj,xk,xl,alphai,alphaj,alphak,alphal)
    ...
    # ABD eq 11.
    G[0,0] = pi*exp(-alphai*alphaj*(xi-xj)^2/(alphai+alphaj)
                    -alphak*alphal*(xk-xl)^2/(alphak+alphal))/sqrt(A*B)

    if n > 0 G[1,0] = C*G[0,0] end  # ABD eq 15
    if m > 0 G[0,1] = Cp*G[0,0] end # ABD eq 16
...
@inline function RecurFactors(t,A,B,Px,Qx,xi,xk)
...
function Root1(X,roots,weights)
  ...
  elseif X < 1.
    ...
    weights[1] = (X+X)*F1+exp(-X)
    roots[1] = F1/(weights[1]-F1)
  elseif X < 3.
    Y = X-2.0E+00
  ...
  elseif X < 10
    E = exp(-X)
    weights[1] = (((((( 4.6897511375022E-01/X-6.9955602298985E-01)/X +
  ...
  elseif X < 15
      E = exp(-X)
      weights[1] = (((-1.8784686463512E-01/X+2.2991849164985E-01)/X -
              4.9893752514047E-01)/X-2.1916512131607E-05)*E + sqrt(PIE4/X)
      F1 = (weights[1]-E)/(X+X)
      roots[1] = F1/(weights[1]-F1)
    elseif X < 33
      E = exp(-X)
      weights[1] = (( 1.9623264149430E-01/X-4.9695241464490E-01)/X -
...
function Root2(X,roots,weights)
  ...
  R33,W33 = 5.52534374226326E+00, 5.11156880411248E-03
  if X < 3.e-7
    roots[1] = 1.30693606237085E-01-2.90430236082028E-02 *X
    roots[2] = 2.86930639376291E+00-6.37623643058102E-01 *X
    weights[1] = 6.52145154862545E-01-1.22713621927067E-01 *X
    weights[2] = 3.47854845137453E-01-2.10619711404725E-01 *X
  elseif X < 1.
    F1 = ((((((((-8.36313918003957E-08*X+1.21222603512827E-06 )*X-
                1.15662609053481E-05 )*X+9.25197374512647E-05 )*X-
              6.40994113129432E-04 )*X+3.78787044215009E-03 )*X-
          ...
          1.99999999997023E-01 )*X+3.33333333333318E-01
    weights[1] = (X+X)*F1+exp(-X)
    roots[1] = (((((((-2.35234358048491E-09*X+2.49173650389842E-08)*X-
    ...
    roots[2] = (((((((-2.47404902329170E-08*X+2.36809910635906E-07)*X+
    ...
    weights[2] = ((F1-weights[1])*roots[1]+F1)*(1.0E+00+roots[2])/(roots[2]-roots[1])
  ...
  elseif X < 3.
    ...
    F1 = ((((((((((-1.61702782425558E-10*Y+1.96215250865776E-09 )*Y-
          ...
          5.29428148329736E-02 )*Y+1.15702180856167E-01
    weights[1] = (X+X)*F1+exp(-X)
    roots[1] = (((((((((-6.36859636616415E-12*Y+8.47417064776270E-11)*Y-
    ...
    roots[2] = ((((((((( 1.45331350488343E-10*Y+2.07111465297976E-09)*Y-
  ...
  elseif X < 5.
    ...
    F1 = ((((((((((-2.62453564772299E-11*Y+3.24031041623823E-10 )*Y-
          ...
          1.75257821619926E-02 )*Y+5.28406320615584E-02
    weights[1] = (X+X)*F1+exp(-X)
    roots[1] = ((((((((-4.11560117487296E-12*Y+7.10910223886747E-11)*Y-
    ...
    roots[2] = (((((((((-1.80555625241001E-10*Y+5.44072475994123E-10)*Y+
  ...
  elseif X < 10
    ...
    F1 = (weights[1]-E)/(X+X)
    Y = X-7.5E+00
    roots[1] = (((((((((((((-1.43632730148572E-16*Y+2.38198922570405E-16)*
    ...
    roots[2] = (((((((((((( 2.48791622798900E-14*Y-1.36113510175724E-13)*Y-
  ...
  elseif X < 15
    ...
    weights[1] = (((-1.8784686463512E-01/X+2.2991849164985E-01)/X -
            4.9893752514047E-01)/X-2.1916512131607E-05)*E + sqrt(PIE4/X)
    F1 = (weights[1]-E)/(X+X)
    roots[1] = ((((-1.01041157064226E-05*X+1.19483054115173E-03)*X -
    ...
    roots[2] = ((( 3.39024225137123E-04*X-9.34976436343509E-02)*X -
  ...
  elseif X < 33
    ...
    weights[1] = (( 1.9623264149430E-01/X-4.9695241464490E-01)/X -
            6.0156581186481E-05)*E + sqrt(PIE4/X)
    F1 = (weights[1]-E)/(X+X)
    roots[1] = ((((-1.14906395546354E-06*X+1.76003409708332E-04)*X -
    ...
    roots[2] = ((( 3.64921633404158E-04*X-9.71850973831558E-02)*X -
    ...
    if X < 40
        E = exp(-X)
        roots[1] = (-8.78947307498880E-01*X+1.09243702330261E+01)*E + R12/(X-R12)
        roots[2] = (-9.28903924275977E+00*X+8.10642367843811E+01)*E + R22/(X-R22)
        weights[2] = ( 4.46857389308400E+00*X-7.79250653461045E+01)*E + W22*weights[1]
        weights[1] = weights[1]-weights[2]
    else
        roots[1] = R12/(X-R12)
        roots[2] = R22/(X-R22)
        weights[2] = W22*weights[1]
        weights[1] = weights[1]-weights[2]
    end 
  end
...
function Root3(X,roots,weights)
  ...
  R33,W33 = 5.52534374226326E+00, 5.11156880411248E-03
  if X < 3.e-7
    roots[1] = 6.03769246832797E-02-9.28875764357368E-03 *X
    roots[2] = 7.76823355931043E-01-1.19511285527878E-01 *X
    roots[3] = 6.66279971938567E+00-1.02504611068957E+00 *X
    weights[1] = 4.67913934572691E-01-5.64876917232519E-02 *X
    weights[2] = 3.60761573048137E-01-1.49077186455208E-01 *X
    weights[3] = 1.71324492379169E-01-1.27768455150979E-01 *X
  elseif X < 1.
    roots[1] = ((((((-5.10186691538870E-10*X+2.40134415703450E-08)*X-
    ...
    roots[2] = ((((((-1.29646524960555E-08*X+7.74602292865683E-08)*X+
    ...
    roots[3] = ((((((-9.28536484109606E-09*X-3.02786290067014E-07)*X-
    ...
    F1 = ((X+X)*F2+E)/3.0E+00
    weights[1] = (X+X)*F1+E
    T1 = roots[1]/(roots[1]+1.0E+00)
    T2 = roots[2]/(roots[2]+1.0E+00)
    T3 = roots[3]/(roots[3]+1.0E+00)
    A2 = F2-T1*F1
    A1 = F1-T1*weights[1]
    weights[3] = (A2-T2*A1)/((T3-T2)*(T3-T1))
    weights[2] = (T3*A1-A2)/((T3-T2)*(T2-T1))
    weights[1] = weights[1]-weights[2]-weights[3]
  elseif X < 3.
    Y = X-2.0E+00
    roots[1] = (((((((( 1.44687969563318E-12*Y+4.85300143926755E-12)*Y-
    ...
    roots[2] = ((((((( 6.95964248788138E-10*Y-5.35281831445517E-09)*Y-
    ...
    roots[3] = ((((((((-2.81496588401439E-10*Y+3.61058041895031E-09)*Y+
  ...
  elseif X < 5.
    Y = X-4.0E+00
    roots[1] = ((((((( 1.44265709189601E-11*Y-4.66622033006074E-10)*Y+
    ...
    roots[2] = ((((((((-2.65526039155651E-11*Y+1.97549041402552E-10)*Y+
    ...
    roots[3] = ((((((((-3.92833750584041E-10*Y-4.16423229782280E-09)*Y+
  ...
  elseif X < 10
    ...
    F2 = (F1+F1+F1-E)/(X+X)
    Y = X-7.5E+00
    roots[1] = ((((((((((( 5.74429401360115E-16*Y+7.11884203790984E-16)*Y-
    ...
    roots[2] = ((((((((((( 1.13464096209120E-14*Y+6.99375313934242E-15)*Y-
    ...
    roots[3] = (((((((((((( 6.66339416996191E-15*Y+1.84955640200794E-13)*Y-
  ...
  elseif X < 15
    ...
    F2 = (F1+F1+F1-E)/(X+X)
    Y = X-12.5E+00
    roots[1] = ((((((((((( 4.42133001283090E-16*Y-2.77189767070441E-15)*Y-
    ...
    roots[2] = ((((((((((( 6.85146742119357E-15*Y-1.08257654410279E-14)*Y-
    ...
    roots[3] = (((((((((((( 3.20622388697743E-15*Y-2.73458804864628E-14)*Y-
  ...
  elseif X < 33
    ...
    F2 = (F1+F1+F1-E)/(X+X)
    if X < 20
        roots[1] = ((((((-2.43270989903742E-06*X+3.57901398988359E-04)*X -
        ...
        roots[2] = (((((-2.62627010965435E-04*X+3.49187925428138E-02)*X -
        ...
        roots[3] = ((((( 9.31856404738601E-05*X-2.87029400759565E-02)*X -
    ...
    if X < 47
        E = exp(-X)
        roots[1] = ((-7.39058467995275E+00*X+3.21318352526305E+02)*X -
                3.99433696473658E+03)*E + R13/(X-R13)
        roots[2] = ((-7.38726243906513E+01*X+3.13569966333873E+03)*X -
                3.86862867311321E+04)*E + R23/(X-R23)
        roots[3] = ((-2.63750565461336E+02*X+1.04412168692352E+04)*X -
                1.28094577915394E+05)*E + R33/(X-R33)
        weights[3] = ((( 1.52258947224714E-01*X-8.30661900042651E+00)*X +
                1.92977367967984E+02)*X-1.67787926005344E+03)*E + W33*weights[1]
        weights[2] = (( 6.15072615497811E+01*X-2.91980647450269E+03)*X +
                3.80794303087338E+04)*E + W23*weights[1]
        weights[1] = weights[1]-weights[2]-weights[3]
    else
        roots[1] = R13/(X-R13)
        roots[2] = R23/(X-R23)
        roots[3] = R33/(X-R33)
        weights[2] = W23*weights[1]
        weights[3] = W33*weights[1]
        weights[1] = weights[1]-weights[2]-weights[3]
    end
  end
...
function Root4(X,roots,weights)
    ...
    if X <= 3.0E-7
        roots[1] = 3.48198973061471E-02 -4.09645850660395E-03 *X
        roots[2] = 3.81567185080042E-01 -4.48902570656719E-02 *X
        roots[3] = 1.73730726945891E+00 -2.04389090547327E-01 *X
        roots[4] = 1.18463056481549E+01 -1.39368301742312E+00 *X
        weights[1] = 3.62683783378362E-01 -3.13844305713928E-02 *X
        weights[2] = 3.13706645877886E-01 -8.98046242557724E-02 *X
        weights[3] = 2.22381034453372E-01 -1.29314370958973E-01 *X
        weights[4] = 1.01228536290376E-01 -8.28299075414321E-02 *X
    elseif X <= 1.0
        roots[1] = ((((((-1.95309614628539E-10*X+5.19765728707592E-09)*X-
        ...
        roots[2] = (((((-1.89554881382342E-08*X+3.07583114342365E-07)*X+
                  1.270981734393E-06)*X-1.417298563884E-04)*X+
                3.226979163176E-03)*X-4.48902570678178E-02 )*X+
                3.81567185080039E-01
        roots[3] = (((((( 1.77280535300416E-09*X+3.36524958870615E-08)*X-
        ...
        roots[4] = (((((-5.61188882415248E-08*X-2.49480733072460E-07)*X+
                  3.428685057114E-06)*X+1.679007454539E-04)*X+
                4.722855585715E-02)*X-1.39368301737828E+00 )*X+
                1.18463056481543E+01
        weights[1] = ((((((-1.14649303201279E-08*X+1.88015570196787E-07)*X-
        ...
        weights[2] = ((((((((-4.11720483772634E-09*X+6.54963481852134E-08)*X-
        ...
        weights[3] = ((((((((-3.41688436990215E-08*X+5.07238960340773E-07)*X-
        ...
        weights[4] = ((((((((( 4.99660550769508E-09*X-7.94585963310120E-08)*X+
    ...
    elseif X <= 5
        Y = X-3.0E+00
        roots[1] = (((((((((-1.48570633747284E-15*Y-1.33273068108777E-13)*Y+
        ...
        roots[2] = ((((((((( 1.35830583483312E-13*Y-2.29772605964836E-12)*Y-
        ...
        roots[3] = ((((((((( 5.02799392850289E-13*Y+1.07461812944084E-11)*Y-
        ...
        roots[4] = (((((((((-1.08510370291979E-12*Y+6.41492397277798E-11)*Y+
        ...
        weights[1] = ((((((((((-4.65801912689961E-14*Y+7.58669507106800E-13)*Y-
        ...
        weights[2] = ((((((((((((-1.46345073267549E-14*Y+2.25644205432182E-13)*Y-
        ...
        weights[3] = ((((((((((((( 9.06812118895365E-15*Y-1.40541322766087E-13)*
        ...
        weights[4] = ((((((((((((((-9.74835552342257E-16*Y+1.57857099317175E-14)*
    ...
    elseif X <= 10.0
        Y = X-7.5E+00
        roots[1] = ((((((((( 4.64217329776215E-15*Y-6.27892383644164E-15)*Y+
        ...
        roots[2] = ((((((((( 2.93981127919047E-14*Y+8.47635639065744E-13)*Y-
        ...
        roots[3] = (((((((((( 2.93523563363000E-14*Y-6.40041776667020E-14)*Y-
        ...
        roots[4] = (((((((((((-1.62212382394553E-14*Y+7.68943641360593E-13)*Y+
        ...
        weights[1] = ((((((((((-1.65995045235997E-15*Y+6.91838935879598E-14)*Y-
        ...
        weights[2] = ((((((((((((-3.57248951192047E-16*Y+6.25708409149331E-15)*Y-
        ...
        weights[3] = ((((((((((((( 1.64742458534277E-16*Y-2.68512265928410E-15)*
        ...
        weights[4] = ((((((((((((((-1.55714130075679E-17*Y+2.57193722698891E-16)*
    ...
    elseif X <= 15
        Y = X-12.5E+00
        roots[1] = ((((((((((( 4.94869622744119E-17*Y+8.03568805739160E-16)*Y-
        ...
        roots[2] = ((((((((((( 4.89224285522336E-16*Y+1.06390248099712E-14)*Y-
        ...
        roots[3] = (((((((((( 6.12419396208408E-14*Y+1.12328861406073E-13)*Y-
        ...
        roots[4] = ((((((((((( 4.63414725924048E-14*Y-4.72757262693062E-14)*Y-
        ...
        weights[4] = ((((((((((((( 2.90401781000996E-18*Y-4.63389683098251E-17)*
        ...
        weights[3] = ((((((((((((-4.19569145459480E-17*Y+5.94344180261644E-16)*Y-
        ...
        weights[2] = ((((((((((-6.22272689880615E-15*Y+1.04126809657554E-13)*Y-
        ...
        weights[1] = (((-1.8784686463512E-01/X+2.2991849164985E-01)/X -
                ...
                sqrt(PIE4/X)-weights[4]-weights[3]-weights[2]
    elseif X <= 20
        weights[1] = sqrt(PIE4/X)
        Y = X-17.5E+00
        roots[1] = ((((((((((( 4.36701759531398E-17*Y-1.12860600219889E-16)*Y-
        ...
        roots[2] = ((((((((((( 4.98913142288158E-16*Y-2.60732537093612E-16)*Y-
        ...
        roots[3] = ((((((((((( 1.91498302509009E-15*Y+1.48840394311115E-14)*Y-
        ...
        roots[4] = (((((((((((-5.43697691672942E-15*Y-1.12483395714468E-13)*Y+
        ...
        weights[4] = ((((((((((((-7.56882223582704E-19*Y+7.53541779268175E-18)*Y-
        ...
        weights[3] = (((((((((((-5.54451040921657E-17*Y+2.68748367250999E-16)*Y+
        ...
        weights[2] = (((((((((((-1.86506057729700E-16*Y+1.16661114435809E-15)*Y+
        ...
        weights[1] = (( 1.9623264149430E-01/X-4.9695241464490E-01)/X -
               6.0156581186481E-05)*exp(-X)+weights[1]-weights[2]-weights[3]-weights[4]
    elseif X <= 35
        weights[1] = sqrt(PIE4/X)
        E = exp(-X)
        roots[1] = ((((((-4.45711399441838E-05*X+1.27267770241379E-03)*X -
        ...
        roots[2] = (((((-7.85617372254488E-02*X+6.35653573484868E+00)*X -
        ...
        roots[3] = (((((-2.37900485051067E-01*X+1.84122184400896E+01)*X -
        ...
        roots[4] = ((((((-6.00691586407385E-04*X-3.64479545338439E-01)*X +
        ...
        if X <= 25
            weights[4] = ((((((( 2.33766206773151E-07*X-
                   ...
                   1.66000945117640E+04/X -6.14479071209961E+03)*E + W44*weights[1]
        else
            weights[4] = (((((( 5.74245945342286E-06*X-
                         7.58735928102351E-05)*X +2.35072857922892E-04)*X-
                      3.78812134013125E-03)*X +3.09871652785805E-01)*X-
                    7.11108633061306E+00)*X +5.55297573149528E+01)*E + W44*weights[1]
        end
        weights[3] = (((((( 2.36392855180768E-04*X-9.16785337967013E-03)*X +
          ...
          1.13673298305631E+06)/X-2.81501182042707E+03)*E + W34*weights[1]
        weights[2] = (((((( 7.29841848989391E-04*X-3.53899555749875E-02)*X +
            ...
            7.67135400969617E+05)*E + W24*weights[1]
        weights[1] = (( 1.9623264149430E-01/X-4.9695241464490E-01)/X -
            6.0156581186481E-05)*E + weights[1]-weights[2]-weights[3]-weights[4]
    elseif X <= 53
        weights[1] = sqrt(PIE4/X)
        E = exp(-X)*(X*X)^2
        roots[4] = ((-2.19135070169653E-03*X-1.19108256987623E-01)*X -
               7.50238795695573E-01)*E + R44/(X-R44)
        roots[3] = ((-9.65842534508637E-04*X-4.49822013469279E-02)*X +
               6.08784033347757E-01)*E + R34/(X-R34)
        roots[2] = ((-3.62569791162153E-04*X-9.09231717268466E-03)*X +
               1.84336760556262E-01)*E + R24/(X-R24)
        roots[1] = ((-4.07557525914600E-05*X-6.88846864931685E-04)*X +
               1.74725309199384E-02)*E + R14/(X-R14)
        weights[4] = (( 5.76631982000990E-06*X-7.89187283804890E-05)*X +
               3.28297971853126E-04)*E + W44*weights[1]
        weights[3] = (( 2.08294969857230E-04*X-3.77489954837361E-03)*X +
               2.09857151617436E-02)*E + W34*weights[1]
        weights[2] = (( 6.16374517326469E-04*X-1.26711744680092E-02)*X +
               8.14504890732155E-02)*E + W24*weights[1]
        ...
        roots[3] = R34/(X-R34)
        roots[4] = R44/(X-R44)
        weights[4] = W44*weights[1]
        weights[3] = W34*weights[1]
        weights[2] = W24*weights[1]
        weights[1] = weights[1]-weights[2]-weights[3]-weights[4]
    end
...
function Root5(X,roots,weights)
    ...
    if X < 3.e-7
        roots[1] = 2.26659266316985E-02 -2.15865967920897E-03 *X
        roots[2] = 2.31271692140903E-01 -2.20258754389745E-02 *X
        roots[3] = 8.57346024118836E-01 -8.16520023025515E-02 *X
        roots[4] = 2.97353038120346E+00 -2.83193369647137E-01 *X
        roots[5] = 1.84151859759051E+01 -1.75382723579439E+00 *X
        weights[1] = 2.95524224714752E-01 -1.96867576909777E-02 *X
        weights[2] = 2.69266719309995E-01 -5.61737590184721E-02 *X
        weights[3] = 2.19086362515981E-01 -9.71152726793658E-02 *X
        weights[4] = 1.49451349150580E-01 -1.02979262193565E-01 *X
        weights[5] = 6.66713443086877E-02 -5.73782817488315E-02 *X
    elseif X < 1.0
        roots[1] = ((((((-4.46679165328413E-11*X+1.21879111988031E-09)*X-
        ...
        roots[2] = (((((( 1.93117331714174E-10*X-4.57267589660699E-09)*X+
        ...
        weights[2] = ((((((( 8.62848118397570E-09*X-1.38975551148989E-07)*X+
        ...
        weights[3] = ((((((((-9.41953204205665E-09*X+1.47452251067755E-07)*X-
        ...
        weights[4] = ((((((((-3.84961617022042E-08*X+5.66595396544470E-07)*X-
        ...
        weights[5] = ((((((((( 4.09594812521430E-09*X-6.47097874264417E-08)*X+
    ...
    elseif X < 5.0
        Y = X-3.0E+00
        roots[1] = ((((((((-2.58163897135138E-14*Y+8.14127461488273E-13)*Y-
        ...
        roots[2] = ((((((((( 1.04525287289788E-14*Y+5.44611782010773E-14)*Y-
        ...
        roots[3] = (((((((((-6.89693150857911E-14*Y+5.92064260918861E-13)*Y+
        ...
        roots[4] = ((((((((-3.61293809667763E-12*Y-2.70803518291085E-11)*Y+
        ...
        roots[5] = ((((((((( 7.12332088345321E-13*Y+3.16578501501894E-12)*Y-
        ...
        weights[1] = ((((((((( 1.04348658616398E-13*Y-1.94147461891055E-12)*Y+
        ...
        weights[2] = ((((((((((( 3.23496149760478E-14*Y-5.24314473469311E-13)*Y+
        ...
        weights[3] = ((((((((((((-3.42790561802876E-14*Y+5.26475736681542E-13)*Y-
        ...
        weights[4] = ((((((((((((( 1.04072340345039E-14*Y-1.60808044529211E-13)*
        ...
        weights[5] = ((((((((((((((-8.16770412525963E-16*Y+1.31376515047977E-14)*
    ...
    elseif X < 10.0
        Y = X-7.5E+00
        roots[1] = ((((((((-1.13825201010775E-14*Y+1.89737681670375E-13)*Y-
        ...
        roots[2] = (((((((((-3.67160504428358E-15*Y+1.27876280158297E-14)*Y-
        ...
        roots[3] = ((((((((( 1.39017367502123E-14*Y-6.96391385426890E-13)*Y+
        ...
        roots[4] = ((((((((((-1.27815158195209E-14*Y+1.99910415869821E-14)*Y+
        ...
        roots[5] = ((((((((((-1.19442341030461E-13*Y-2.34074833275956E-12)*Y+
        ...
        weights[1] = ((((((((( 7.95526040108997E-15*Y-2.48593096128045E-13)*Y+
        ...
        weights[2] = ((((((((((( 1.25678686624734E-15*Y-2.34266248891173E-14)*Y+
        ...
        weights[3] = ((((((((((((-8.20929494859896E-16*Y+1.37356038393016E-14)*Y-
        ...
        weights[4] = ((((((((((((((-1.08764612488790E-17*Y+1.85299909689937E-16)*
        ...
        weights[5] = ((((((((((((((( 7.28996979748849E-19*Y-1.26518146195173E-17)
    ...
    elseif X < 15.0
        Y = X-12.5E+00
        roots[1] = ((((((((((-4.16387977337393E-17*Y+7.20872997373860E-16)*Y+
        ...
        roots[2] = ((((((((((-4.56279214732217E-16*Y+6.24941647247927E-15)*Y+
        ...
        roots[3] = ((((((((((-2.52879337929239E-15*Y+2.13925810087833E-14)*Y+
        ...
        roots[4] = ((((((((((-6.42391438038888E-15*Y+5.37848223438815E-15)*Y+
        ...
        roots[5] = (((((((((((-2.24366166957225E-14*Y+4.87224967526081E-14)*Y+
        ...
        weights[1] = ((((((((( 8.98007931950169E-15*Y+7.25673623859497E-14)*Y+
        ...
        weights[2] = ((((((((((-1.05490525395105E-15*Y+1.96855386549388E-14)*Y-
        ...
        weights[3] = ((((((((((( 3.60020423754545E-16*Y-6.24245825017148E-15)*Y+
        ...
        weights[4] = ((((((((((((( 2.51163533058925E-18*Y-4.31723745510697E-17)*
        ...
        weights[5] = ((((((((((((((-1.29043630202811E-19*Y+2.16234952241296E-18)*
    ...
    elseif X < 20.0
        Y = X-17.5E+00
        roots[1] = (((((((((( 1.91875764545740E-16*Y+7.8357401095707E-16)*Y-
        ...
        roots[2] = (((((((((( 2.02778478673555E-15*Y+1.01640716785099E-14)*Y-
        ...
        roots[3] = (((((((((( 7.79850771456444E-15*Y+6.00464406395001E-14)*Y-
        ...
        roots[4] = (((((((((((-2.92397030777912E-15*Y+1.94152129078465E-14)*Y+
        ...
        roots[5] = ((((((((((( 1.17976126840060E-14*Y+1.24156229350669E-13)*Y-
        ...
        weights[1] = (((((((((( 1.74841995087592E-15*Y-6.95671892641256E-16)*Y-
        ...
        weights[2] = ((((((((((-1.11199320525573E-15*Y+1.85007587796671E-15)*Y+
        ...
        weights[3] = ((((((((((-9.49816486853687E-16*Y+6.67922080354234E-15)*Y+
        ...
        weights[4] = ((((((((((( 1.33829971060180E-17*Y-3.44841877844140E-16)*Y+
        ...
        weights[5] = ((((((((((((( 2.69412277020887E-20*Y-4.24837886165685E-19)*
    ...
    elseif X < 25.0
        Y = X-22.5E+00
        roots[1] = (((((((((-1.13927848238726E-15*Y+7.39404133595713E-15)*Y+
        ...
        roots[2] = (((((((((( 2.89872355524581E-16*Y-1.22296292045864E-14)*Y+
        ...
        roots[3] = (((((((((( 1.97068646590923E-15*Y-4.89419270626800E-14)*Y+
        ...
        roots[4] = (((((((((( 1.33642069941389E-14*Y-1.55850612605745E-13)*Y-
        ...
        roots[5] = ((((((((((-6.07053986130526E-14*Y+1.04447493138843E-12)*Y-
        ...
        weights[1] = (((((((((-9.10338640266542E-15*Y+1.00438927627833E-13)*Y+
        ...
        weights[2] = ((((((((( 5.52380927618760E-15*Y-6.43424400204124E-14)*Y-
        ...
        weights[3] = ((((((((( 3.99457454087556E-15*Y-5.11826702824182E-14)*Y-
        ...
        weights[4] = (((((((((((-2.14649508112234E-18*Y-2.45525846412281E-18)*Y+
        ...
        weights[5] = ((((((((((((-5.63938733073804E-21*Y+6.92182516324628E-20)*Y-
    ...
    elseif X < 40
        weights[1] = sqrt(PIE4/X)
        E = exp(-X)
        roots[1] = ((((((((-1.73363958895356E-06*X+1.19921331441483E-04)*X -
        ...
        roots[2] = ((((((((-1.60102542621710E-05*X+1.10331262112395E-03)*X -
        ...
        roots[3] = ((((((((-4.48880032128422E-05*X+2.69025112122177E-03)*X -
        ...
        roots[4] = ((((((((-6.38526371092582E-05*X-2.29263585792626E-03)*X -
        ...
        roots[5] = ((((((((-3.59049364231569E-05*X-2.25963977930044E-02)*X +
        ...
        weights[5] = (((((((((-4.61100906133970E-10*X+1.43069932644286E-07)*X -
                ...
                3.02260070158372E+03)*X+9.71575094154768E+03)*E + W55*weights[1]
        weights[4] = (((((((((-2.40799435809950E-08*X+8.12621667601546E-06)*X -
                ...
                1.81852473229081E+05)*X+5.96854758661427E+05)*E + W45*weights[1]
        weights[3] = (((((((( 1.83574464457207E-05*X-1.54837969489927E-03)*X +
               ...
               2.26410896607237E+06)*E + W35*weights[1]
        weights[2] = (((((((( 2.77778345870650E-05*X-2.22835017655890E-03)*X +
               ...
               3.10638627744347E+06)*E + W25*weights[1]
        weights[1] = weights[1]-0.01962E+00*E-weights[2]-weights[3]-weights[4]-weights[5]
    elseif X < 59.0
        weights[1] = sqrt(PIE4/X)
        XXX = X^3
        E = XXX*exp(-X)
        roots[1] = (((-2.43758528330205E-02*X+2.07301567989771E+00)*X -
                6.45964225381113E+01)*X+7.14160088655470E+02)*E + R15/(X-R15)
        roots[2] = (((-2.28861955413636E-01*X+1.93190784733691E+01)*X -
                5.99774730340912E+02)*X+6.61844165304871E+03)*E + R25/(X-R25)
        roots[3] = (((-6.95053039285586E-01*X+5.76874090316016E+01)*X -
                1.77704143225520E+03)*X+1.95366082947811E+04)*E + R35/(X-R35)
        roots[4] = (((-1.58072809087018E+00*X+1.27050801091948E+02)*X -
                3.86687350914280E+03)*X+4.23024828121420E+04)*E + R45/(X-R45)
        roots[5] = (((-3.33963830405396E+00*X+2.51830424600204E+02)*X -
                7.57728527654961E+03)*X+8.21966816595690E+04)*E + R55/(X-R55)
        E = XXX*E
        weights[5] = (( 1.35482430510942E-08*X-3.27722199212781E-07)*X +
               2.41522703684296E-06)*E + W55*weights[1]
        weights[4] = (( 1.23464092261605E-06*X-3.55224564275590E-05)*X +
               3.03274662192286E-04)*E + W45*weights[1]
        weights[3] = (( 1.34547929260279E-05*X-4.19389884772726E-04)*X +
               3.87706687610809E-03)*E + W35*weights[1]
        weights[2] = (( 2.09539509123135E-05*X-6.87646614786982E-04)*X +
               6.68743788585688E-03)*E + W25*weights[1]
        weights[1] = weights[1]-weights[2]-weights[3]-weights[4]-weights[5]
    else
        weights[1] = sqrt(PIE4/X)
        roots[1] = R15/(X-R15)
        roots[2] = R25/(X-R25)
        ...
        roots[4] = R45/(X-R45)
        roots[5] = R55/(X-R55)
        weights[2] = W25*weights[1]
        weights[3] = W35*weights[1]
        weights[4] = W45*weights[1]
        weights[5] = W55*weights[1]
        weights[1] = weights[1]-weights[2]-weights[3]-weights[4]-weights[5]
    end
    return  #[roots[1],roots[2],roots[3],roots[4],roots[5]],[weights[1],weights[2],weights[3],weights[4],weights[5]]
end

"Composite Root123 is not used anymore in favor of Root1, Root2, Root3"
function Root123(n,X)
    ...
    elseif X < 1.
      ...
      elseif n == 2
        ...
        weights[2] = ((F1-weights[1])*roots[1]+F1)*(1.0E+00+roots[2])/(roots[2]-roots[1])
        weights[1] = weights[1]-weights[2]
        return [roots[1],roots[2]],[weights[1],weights[2]]
      elseif n == 3
          roots[1] = ((((((-5.10186691538870E-10*X+2.40134415703450E-08)*X-
                5.01081057744427E-07 )*X+7.58291285499256E-06 )*X-
              9.55085533670919E-05 )*X+1.02893039315878E-03 )*X-
