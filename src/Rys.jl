...
function RecurFactors(t,A,B,Px,Qx,xi,xk)
    # ABD eqs 12-14
    fact = t/(A+B)                
    B0 = 0.5*fact                 
    B1 = (1-B*fact)/(2*A)         
...
function RecurFactorsGamess(t,A,B,Px,Qx,xi,xk)
  ...
  elseif X < 33
    ...
    if X < 47
        ...
        WW3 = ((( 1.52258947224714E-01*X-8.30661900042651E+00)*X +
                1.92977367967984E+02)*X-1.67787926005344E+03)*E + W33*WW1
